    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loginType', models.CharField(choices=[('KAKAO', 'Kakao')], default='KAKAO', max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('roleType', models.CharField(choices=[('ADMIN', 'Admin'), ('NORMAL', 'Normal'), ('BLACKLIST', 'Blacklist')], default='NORMAL', max_length=64)),
            ],
            options={
